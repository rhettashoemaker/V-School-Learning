...
while (time > 0 && socialReserves > 0 && counter < 10 ) {
    if (socialReserves <= 0) {
        ...
        console.log("Name: " + name + "\nTurns taken: " + counter + "\nTime left: " + time + "\nSocial Reserves left: " + socialReserves + "Events that happened: " + eventsThatHappened + "\nExperiences:" + inventory)
        process.exit();
    }
                ...
                while (event.persistence > 0) {
                    if (time > 0 && socialReserves > 0 && counter < 10) {
                        ...
                        if (event.persistence > 0 && time > 0 && socialReserves > 0 && counter < 10) {
                            ...
                            inventory.push(event.item);
                            eventOptions.splice(eventOptions.indexOf(event), 1);
                            eventsThatHappened.push(event.name);
